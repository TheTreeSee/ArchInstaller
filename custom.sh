...
HOSTNAME="michaelthinksarch"      # Default hostname
USERNAME="michael"            # Default user
...
DISK="/dev/nvme0n1p"             # Default disk for installation
...
KEYMAP="us"            # Keyboard layout (us, colemak, fr)
